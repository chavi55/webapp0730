...
# 5단계 이산형 구간 색상 맵 (낮은 쪽은 옅게, 높은 쪽은 진하게)
color_discrete_map = {
    '19% 미만': '#f7fbff',
    '19% 이상 ~ 23% 미만': '#c6dbef',
    '23% 이상 ~ 28% 미만': '#6baed6',
...
# 레이아웃 및 호버 툴팁 박스 스타일 설정
fig.update_layout(
    margin={"r": 0, "t": 30, "l": 0, "b": 0},
    # 호버 툴팁 박스 (파란색 포인트 테두리와 텍스트)
    hoverlabel=dict(
        bgcolor="#f0f4ff",
        bordercolor="#0055ff",
        font_size=14,
...
# [수정] Plotly 정식 속성으로 경계선 및 호버 포맷만 지정
fig.update_traces(
    marker_line_width=1.2,
    marker_line_color="#444444",  # 구분을 위한 경계선 색상
    hovertemplate=(
